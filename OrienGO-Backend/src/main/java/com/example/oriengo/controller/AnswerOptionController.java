...
public class AnswerOptionController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<List<AnswerOptionResponseDTO>>> getAnswerOptions(){
        List<AnswerOption> answerOptions = answerOptionService.getAnswerOptions();
        List<AnswerOptionResponseDTO> answerOptionResps = answerOptionMapper.toDTO(answerOptions);
        ApiResponse<List<AnswerOptionResponseDTO>> response = ApiResponse.<List<AnswerOptionResponseDTO>>builder()
                .code("SUCCESS")
                .status(200)
